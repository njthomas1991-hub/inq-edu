...
class TeachingResourceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            # DESCRIPTION
            Row(Column("description", css_class="col-12"), css_class="g-3"),
            # RESOURCE SETTINGS
            Row(
            ...
            # FILES
            Row(
                Column("uploaded_file", css_class="col-md-6"),
                Column("image", css_class="col-md-6"),
                css_class="g-3",
            ),
            # COMMENTS
            Row(Column("allow_comments", css_class="col-12"), css_class="g-3"),
        )
    ...
    class Meta:
        ...
        labels = {
            "uploaded_file": ("Upload Resource File"),
            "image": ("Upload Cover Image"),
            "allow_comments": ("Allow comments and discussion"),
        }
