...
class ClassModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.class2 = Class.objects.create(
            name="Science Advanced", teacher=self.teacher, subject="science", year_ks=3
        )
...
class ClassStudentModelTestCase(TestCase):
    ...
    def test_unique_enrollment(self):
        ...
        with self.assertRaises(IntegrityError):
            ClassStudent.objects.create(student=self.student, clazz=self.class_obj)
...
class AvatarModelTestCase(TestCase):
    ...
    def test_one_avatar_per_user(self):
        ...
        with self.assertRaises(IntegrityError):
            Avatar.objects.create(user=self.user, body_color="#00FF00")
...
class AuthenticationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.admin = User.objects.create_user(
            username="admin1", password="testpass123", role="school_admin"
        )
...
class AccessControlTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.class1 = Class.objects.create(
            name="Teacher 1 Class", teacher=self.teacher1, subject="maths", year_ks=2
        )
...
class ClassCRUDTestCase(TestCase):
    ...
    def test_read_class_list(self):
        ...
        Class.objects.create(
            name="Test Class", teacher=self.teacher, subject="science", year_ks=2
        )
        response = self.client.get(reverse("teacher_dashboard"))
        self.assertEqual(response.status_code, 200)
    ...
    def test_read_class_detail(self):
        ...
        class_obj = Class.objects.create(
            name="Detail Test Class", teacher=self.teacher, subject="english", year_ks=1
        )
...
class AnalyticsViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.class1 = Class.objects.create(
            name="Math Class", teacher=self.teacher, subject="maths", year_ks=2
        )
        self.class2 = Class.objects.create(
            name="Science Class", teacher=self.teacher, subject="science", year_ks=3
        )
        self.student = User.objects.create_user(
            username="student1", password="testpass123", role="student"
        )
...
class SchoolAdminViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.analytics_profile = SchoolAnalyticsProfile.objects.create(
            user=self.admin, school="Test School"
        )
        self.teacher = User.objects.create_user(
            username="teacher1",
            password="testpass123",
...
class FormValidationTestCase(TestCase):
    ...
    def test_class_form_validation_missing_fields(self):
        ...
        data = {"name": "", "subject": "maths", "year_ks": 2}  # Empty name should fail
        response = self.client.post(reverse("create_class"), data)
